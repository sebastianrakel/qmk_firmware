...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x6(
        ...
        MO(_RAISE),KC_GRAVE,KC_BSLS,KC_LEFT,KC_RGHT,                                        KC_UP  ,KC_DOWN,KC_LBRC,KC_RBRC,MO(_LOWER),
        KC_LCTL,KC_DEL,KC_END,KC_LALT, KC_HOME, KC_BSPC,                                       KC_RWIN,KC_SPC,KC_PGUP, KC_RCTL,KC_PGDN,KC_ENT
    ),
    [_LOWER] = LAYOUT_6x6(
    ...
    [_RAISE] = LAYOUT_6x6(
        ...
        _______,QK_BOOT,_______,KC_BTN1,KC_BTN2,_______,                                       KC_WBAK,KC_VOLU,KC_VOLD,KC_MUTE,_______,_______,
                                                _______,_______,_______,       _______,_______,_______,
                                                                _______,       _______,
                                                                _______,       _______
    )
